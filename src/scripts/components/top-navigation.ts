            ...
            <div class="nav-list" role="list">
              <span role="listitem" popovertarget="products-popover"
                ...
                <div class="menu-popover" id="products-popover" popover="auto">
                  ...
                  <a href="/products/add-ons/" class="menu">
                    <div class="img-container">
                      <svg xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24" viewBox="0 0 512 512">
                      <g>
                        <path fill="#2CFF05" stroke-width="5" d="M446.25,234.406c-8.219,0-15.844,2.156-22.594,5.281v-42.75c0-35.531-28.906-64.438-64.438-64.438H316.5
                    ...
                    <div class="description-container">
                      <span class="heading">Add-ons</span>
                      <span class="subheading"
                        >Add-ons to extend your favourite productivity tools</span
                      >
                    </div>
                  </a>
                </div>
